...
#        wx.Frame.__init__ ( self, None, id = wx.ID_ANY, title = u"ScholBar", pos = wx.DefaultPosition, size = wx.Size( 1024,545 ), style = wx.DEFAULT_FRAME_STYLE|wx.FRAME_NO_TASKBAR|wx.RESIZE_BORDER|wx.TAB_TRAVERSAL )
        wx.Frame.__init__(self, None, id = wx.ID_ANY, title = u"Wyszukiwarka Publikacji", pos = wx.DefaultPosition, size = wx.Size( 1024,535 ), style = wx.DEFAULT_FRAME_STYLE ^ (wx.RESIZE_BORDER))
        ...
        self.m_menuItem20.SetBitmap( wx.Bitmap( u"../src/icon/fileopen16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem21.SetBitmap( wx.Bitmap( u"../src/icon/back16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem22.SetBitmap( wx.Bitmap( u"../src/icon/clear16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem23.SetBitmap( wx.Bitmap( u"../src/icon/add16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem24.SetBitmap( wx.Bitmap( u"../src/icon/addm16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem25.SetBitmap( wx.Bitmap( u"../src/icon/browser16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem7.SetBitmap( wx.Bitmap( u"../src/icon/autor16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem8.SetBitmap( wx.Bitmap( u"../src/icon/grupa16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem9.SetBitmap( wx.Bitmap( u"../src/icon/pub16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem10.SetBitmap( wx.Bitmap( u"../src/icon/journal16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem11.SetBitmap( wx.Bitmap( u"../src/icon/edit16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem12.SetBitmap( wx.Bitmap( u"../src/icon/delete16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem13.SetBitmap( wx.Bitmap( u"../src/icon/clear16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem14.SetBitmap( wx.Bitmap( u"../src/icon/browser16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem15.SetBitmap( wx.Bitmap( u"../src/icon/globe16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem16.SetBitmap( wx.Bitmap( u"../src/icon/cite16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem17.SetBitmap( wx.Bitmap( u"../src/icon/www16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        self.m_menuItem18.SetBitmap( wx.Bitmap( u"../src/icon/txt16.png", wx.BITMAP_TYPE_ANY ) )
        ...
        stool = self.m_toolBar1.AddLabelTool( 1, u"tool", wx.Bitmap( u"../src/icon/search.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_RADIO, u'Wyszukiwarka', wx.EmptyString ) 
        btool = self.m_toolBar1.AddLabelTool( 2, u"tool", wx.Bitmap( u"../src/icon/base.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_RADIO, u'Baza dancyh', wx.EmptyString ) 
        self.m_toolBar1.AddSeparator()
        addaut = self.m_toolBar1.AddLabelTool( 3, u"tool", wx.Bitmap( u"../src/icon/autor.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Zarządzanie Autorami', wx.EmptyString ) 
        addgru = self.m_toolBar1.AddLabelTool( 4, u"tool", wx.Bitmap( u"../src/icon/grupa.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Zarządzanie Grupami', wx.EmptyString ) 
        addpub = self.m_toolBar1.AddLabelTool( 5, u"tool", wx.Bitmap( u"../src/icon/pub.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Zarządzanie Publikacjami', wx.EmptyString ) 
        addwyd = self.m_toolBar1.AddLabelTool( 6, u"tool", wx.Bitmap( u"../src/icon/journal.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Zarządzanie Wydawcami', wx.EmptyString ) 
        self.m_toolBar1.AddSeparator()
        raport = self.m_toolBar1.AddLabelTool( 7, u"tool", wx.Bitmap( u"../src/icon/fileopen.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Wczytaj pobrane publikacje', wx.EmptyString ) 
        backlist = self.m_toolBar1.AddLabelTool( 8, u"tool", wx.Bitmap( u"../src/icon/back.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Przywróć ostatnie publikacje', wx.EmptyString ) 
        clear = self.m_toolBar1.AddLabelTool( 9, u"tool", wx.Bitmap( u"../src/icon/clear.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Wyczyść listę publikacji', wx.EmptyString ) 
        addrec = self.m_toolBar1.AddLabelTool( 10, u"tool", wx.Bitmap( u"../src/icon/add.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Edytuj i Zapisz wybrane publikacje', wx.EmptyString ) 
        addrecm = self.m_toolBar1.AddLabelTool( 11, u"tool", wx.Bitmap( u"../src/icon/addm.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Dodaj wszystkie wybrane publikacje', wx.EmptyString ) 
        viewpub = self.m_toolBar1.AddLabelTool( 12, u"tool", wx.Bitmap( u"../src/icon/browser.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Wyświetl wybrane publikacje', wx.EmptyString ) 
        self.m_toolBar1.AddSeparator()
        editrec = self.m_toolBar1.AddLabelTool( 13, u"tool", wx.Bitmap( u"../src/icon/edit.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Edytuj wybrane publikacje w bazie', wx.EmptyString ) 
        delrec = self.m_toolBar1.AddLabelTool( 14, u"tool", wx.Bitmap( u"../src/icon/delete.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Usuń wybrane publikacje z bazy', wx.EmptyString ) 
        clearbase = self.m_toolBar1.AddLabelTool( 15, u"tool", wx.Bitmap( u"../src/icon/clear.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Wyczyść listę publikacji', wx.EmptyString ) 
        viewpubbase = self.m_toolBar1.AddLabelTool( 16, u"tool", wx.Bitmap( u"../src/icon/browser.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Wyświetl wybrane publikacje', wx.EmptyString ) 
        viewcitbase = self.m_toolBar1.AddLabelTool( 17, u"tool", wx.Bitmap( u"../src/icon/globe.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Wyświetl cytowania wybranych publikacji', wx.EmptyString ) 
        cit = self.m_toolBar1.AddLabelTool( 18, u"tool", wx.Bitmap( u"../src/icon/cite.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Zarządzanie/Łączenie wybranych publikacji', wx.EmptyString ) 
        self.m_toolBar1.AddSeparator()
        gh = self.m_toolBar1.AddLabelTool( 19, u"tool", wx.Bitmap( u"../src/icon/www.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Generowanie pliku HTML z wybranych publikacji', wx.EmptyString ) 
        gb = self.m_toolBar1.AddLabelTool( 20, u"tool", wx.Bitmap( u"../src/icon/txt.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u'Generowanie pliku Bibtex z wybranych publikacji', wx.EmptyString ) 
